...
const schema = yup.object().shape({
  ...
  name: yup.string().required("Veuillez renseigner un nom").min(2).max(24),
  ...
  password: yup
    .string()
    .min(6, "Les mots de passe doivent comporter au moins 6 caractères")
    .max(24)
      ...
      <div className='dashboard-container'>
        ...
        >
          <Form.Group className='mb-3'>
            <Form.Label className="creation-form-label">Prénom</Form.Label>
            <Form.Control
              type='text'
              {...register("firstname")}
          ...
          <Form.Group className='mb-3'>
					<Form.Label className="creation-form-label">Email</Form.Label>
            <Form.Control
              type='text'
              {...register("email")}
          ...
          <Form.Group className='mb-3'>
					<Form.Label className="creation-form-label">Numéro de telephone</Form.Label>
            <Form.Control
              type='text'
          ...
          <Form.Group className='mb-3'>
					<Form.Label className="creation-form-label">Mot de passe</Form.Label>
            <Form.Control
              type='password'
              {...register("password")}
          ...
          <Form.Group className='mb-3'>
            ...
            <Form.Select aria-label='' name='level' {...register("experience")}>
